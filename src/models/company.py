...
class Company:
    """Model representing a company that can sponsor users."""
    
    def __init__(self, name, description, logo_path=None, political_leaning=Sentiment.NEUTRAL):
        """Initialize a company.
        
        Args:
            name (str): The name of the company
            description (str): A brief description of the company
            logo_path (str, optional): Path to the company logo. Defaults to None.
            political_leaning (Sentiment): The political leaning of the company (LEFT, RIGHT, or NEUTRAL)
        """
        self.name = name
