...
class TestFollower(unittest.TestCase):
    ...
    def test_follower_initialization(self):
        ...
        self.assertIsInstance(self.left_follower.command_history, CommandHistory)
    ...
    def test_create_with_random_handle(self):
        ...
        self.assertTrue(any(prefix in follower.handle for prefix in Follower.FOLLOWER_PREFIXES["LEFT"]))
